...
public class VerifierOnPool extends Thread{
	
	List<ComponentConfig> comp;
	List<ResultSymptom> result;
	int port;
	
	 public VerifierOnPool(List<ComponentConfig> comp, int port) {
		super();
		this.comp = comp;
		this.port = port;
	}
	...
	public List<ResultSymptom> callService(){
		try {
			HttpClient httpClient = HttpClientBuilder.create().build();
			HttpPost request = new HttpPost("http://fasad.cer.auckland.ac.nz:"+port+"/api/patweb/verify");
